...
const Fotter = () => {
    return (
        <>
            <section className='bg-[#EEEFFB] mt-[64px] py-[64px]'>
                <Container>
                    <div className="flex">
                        <div className="w-4/10">
                            <div className="">
                                ...
                                <div className="">
                                    ...
                                    <h4 className='text-[16px] text-[#8A8FB9] font-Lato font-medium mt-[10px]'>17 Princess Road, London, Greater London NW1 8JR, UK</h4>
                                </div>
                            </div>
                        </div>
