        ...
        <>
            <section>
                <Container>
                    ...
                    <div className=" flex justify-between mt-[64px] my-2 gap-x-4">


                        <div className="w-1/4 h-[320px] bg-[rgba(128,128,128,0.05)] hover:bg-[purple] hover:text-[#fff] my-2">
                            <div className="">
